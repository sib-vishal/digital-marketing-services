...
export default function Home({ blogs }) {
  return (
    <div>
      ...
      {/* <div className="bannerBottomLogo b">
        <div className="containerFull">
            ...
            <div className="col-lg-7 pe-lg-4">
              <div className="drivenLeft">
                ...
                <h4 className="sub_heading fontWeight700 mt-3">
                  We are as <span className="titleHighlight">STRONG</span> as
                  YOU <br />
                  Make us
                </h4>
            ...
            <div className="col-lg-5">
              <div className="rightServices">
                ...
                <p className="title mt-4 text-center">
                  ...
                  from your website and digital marketing initiatives, talk to
                  us. All digital marketing is 100% measurable, we know we get
                  results.
                </p>
              </div>
            </div>
        ...
        <div className="containerFull ">
          <div className="row">
            <div className="col-lg-10 offset-lg-1">
              <h4 className="heading text-center fontWeight700">
                Areas of Expertise
              </h4>
              ...
              <p className="text-center mt-3">
                ...
                been helping business in India, UK, Canada, Australia and world
                over to adapt and grow in an ever changing inline world by
                offering fully functional mobile friendly responsive, cheap
            ...
            <div className="inlineService">
              ...
              >
                ...
                <div className="serviceText">
                  <p>
                    Your website is your home on the internet (web). The Website
                    Design is the first and the foremost area which must be
                    concentrated as it is the virtual face of a company.
                  </p>
                </div>
                <Link
              ...
              >
                ...
                <div className="serviceText">
                  <p>
                    Search Engine Optimization is the most efficient and
                    effective method increase your search engine visibility and
                    drive traffic to your website. With our SEO services in
                    India .
                  </p>
                </div>
                <Link
              ...
              >
                ...
                <div className="serviceText">
                  <p>
                    Sit back relax! Hire top notch thinkers, web developers, web
                    designers, and search engineers and quickly scale your
                    delivery capacity. We are a global offshore outsourcing...
                  </p>
                </div>
                <Link
              ...
              >
                ...
                <div className="serviceText">
                  <p>
                    We offer customized web development services using latest
                    frameworks and platforms to build bespoke web applications
                    for websites or Mobile Apps, E-commerce Portals, API links
                    and much more
                  </p>
                </div>
                <Link
              ...
              >
                ...
                <div className="serviceText">
                  <p>
                    In a quest for staying ahead of the technology it is a
                    necessity for any business looking to leverage the power of
                    smartphones to develop mobile apps. Being an experienced...
                  </p>
                </div>
                <Link
              ...
              >
                ...
                <div className="serviceText">
                  <p>
                    ...
                    business optimise operations, unlock a new level of
                    efficiency and transform your ideas into an innovative
                    service or anengaging...
                  </p>
                </div>
                <Link
            ...
            <div className="col-lg-9">
              <div className="titleLeft">
                ...
                <p className="mt-4">
                  ...
                  CMS solution. We do Your business in your way.
                </p>
              </div>
            </div>
      ...
      {/* <section className="lightBg dots curve1">
        <div className="containerFull">
          ...
          <div className="freeText">
            <p className="title">
              We are a young creative web development and digital marketing
              agency for any business - anywhere to promote their business
              online and engage users with brands and convert them to customers
              and experience an overall improvement in client base.
            </p>

            <p className="title">
              In comparison to other SEO companies in India, we are not only an
              affordable SEO Agency, we are a results-focused and driven
              company, So if you're looking for a great looking website and a
              team that can follow through by delivering top rankings and
              brining in tremendous traffic to your website, you've found the
              right organization.
            </p>

            <p className="title">
              We help you drive your digital strategies & meet your business
              objectives in the way you want to promote your website on web with
              our creative and innovative ideas. We ensure that our affordable
              seo packages help your website attains top rankings in various
              search engines like Google, Yahoo, Bing, Baidu, etc. by strictly
              following only white hat SEO techniques to generate the right
              website traffic and results by increasing your ROI.
            </p>

            <p className="title">
              We are an <strong>ISO 9001:2015</strong> certified company with
              professional team of 35+ seasoned experts operating from Mumbai &
              New Delhi with 750+ satisfied clients in our portfolio.
            </p>

            <p className="title">
              If your business deserves no less, call on SIB Infotech The Best
              Website Designing, Development & SEO Agency in Mumbai for all your
              internet marketing & website development needs.
            </p>
          </div>
        </div>
      </section> */}
                ...
                <div className="col-lg-6">
                  <Link href="#">
                    <div className="webDesignItem">
                      ...
                      <p>
                        Using this one can start from just one simple page with
                        an Email link, building...
                      </p>
                      <button>
                        <i className="fa fa-chevron-right"></i>
                      </button>
                ...
                <div className="col-lg-6 translate50">
                  <Link href="#">
                    <div className="webDesignItem">
                      ...
                      <p>
                        Our web design uses the latest technology to look great
                        on any screen sizes...
                      </p>
                      <button>
                        <i className="fa fa-chevron-right"></i>

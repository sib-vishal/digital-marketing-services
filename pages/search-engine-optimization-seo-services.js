...
export default function SearchEngineOptimizationServices() {
    ...
    return (
        <div>
                                ...
                                <div className="rightMain stickyRight">
                                    {activeTab === 'section1' &&
                                        <div className="itemSidebar scroll" id="section1">
                                            <h4 className="sub_heading fontWeight700 fontHeading">ON Page SEO</h4>
                                            <p className="mt-3">On-page SEO is the foundation of any successful SEO strategy. At SIB Infotech, we specialize in providing comprehensive <Link href="/on-page-seo-services">
                                    ...
                                    {activeTab === 'section2' &&
                                        <div className="itemSidebar scroll" id="section2">
                                            <h4 className="sub_heading fontWeight700 fontHeading">OFF Page SEO</h4>
                                            <p className="mt-3">Off-page SEO is activities that are performed after the websites goes live. <Link href="/off-page-seo-services">
                                    ...
                                    {activeTab === 'section3' &&
                                        <div className="itemSidebar scroll" id="section3">
                                            <h4 className="sub_heading fontWeight700 fontHeading">Local SEO</h4>
                                            <p className="mt-3">Put your business on the local map with our tailored <Link href="/local-seo-services">
                                    ...
                                    {activeTab === 'section4' &&
                                        <div className="itemSidebar scroll" id="section4">
                                            <h4 className="sub_heading fontWeight700 fontHeading">Technical SEO</h4>
                                            <p className="mt-3"><Link href="/on-page-seo-services">
                                    ...
                                    {activeTab === 'section5' &&
                                        <div className="itemSidebar scroll" id="section5">
                                            <h4 className="sub_heading fontWeight700 fontHeading">E-Commerce SEO</h4>
                                            <p className="mt-3">Fuel your online store's success with our <Link href="/e-commerce-seo-services">
                                    ...
                                    {activeTab === 'section6' &&
                                        <div className="itemSidebar scroll" id="section6">
                                            <h4 className="sub_heading fontWeight700 fontHeading">Mobile SEO</h4>
                                            <p className="mt-3">Mobile SEO is based on its name, which is meant for mobile devices. At present more than 60% of Google searches are done on mobile phones. This <Link href="/mobile-seo-services">
                ...
                <div className="containerFull">
                    <div className="row">
                        <div className="col-lg-10">
                            <h3 className="sub_heading text-white fontWeight500 fontHeading">Our Specialised Search Engine Optimization Services:</h3>
                        </div>
                    </div>
            ...
            <section>
                <div className="containerFull">
                    <h3 className="sub_heading fontWeight500 fontHeading">We can Get Featured you on Top News Websites</h3>
            ...
            <section className="faqsBg">
                <div className="containerFull">
                    <h3 className="sub_heading fontWeight500 text-white fontHeading">Do You have Questions about Working with SEO Agency in India? <br className="d-none d-lg-block" /> We’ve got your answers.</h3>

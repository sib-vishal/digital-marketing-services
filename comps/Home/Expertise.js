...
//               data-background="url(assets/images/bg/web-design.jpg)"
//             >
//               <h4 className="medium_heading">Website Designing</h4>
//               <div className="serviceText">
//                 <p>
//                   Your website is your home on the internet (web). The Website
//                   Design is the first and the foremost area which must be
...
//                 </p>
//               </div>
//               <Link href="/website-designing-services" className="linkService">
//                 Read More
//               </Link>
//             </div>
//             <div
...
//               data-background="url(assets/images/bg/seo.jpg)"
//             >
//               <h4 className="medium_heading">Search Engine Optimization</h4>
//               <div className="serviceText">
//                 <p>
//                   Search Engine Optimization is the most efficient and effective
//                   method to increase your search engine visibility and drive
//                   traffic to your website. With our SEO services in India.
//                 </p>
//               </div>
//               <Link
//                 href="/search-engine-optimization-seo-services"
...
//               data-background="url(assets/images/bg/offshore.jpg)"
//             >
//               <h4 className="medium_heading">Offshore Outsourcing</h4>
//               <div className="serviceText">
//                 <p>
//                   Sit back and relax! Hire top-notch thinkers, web developers,
//                   web designers, and search engineers and quickly scale your
//                   delivery capacity. We are a global offshore outsourcing...
//                 </p>
//               </div>
//               <Link
...
//               data-background="url(assets/images/bg/web-development.jpg)"
//             >
//               <h4 className="medium_heading">Website Development</h4>
//               <div className="serviceText">
//                 <p>
//                   We offer customized web development services using the latest
//                   frameworks and platforms to build bespoke web applications for
//                   websites or Mobile Apps, E-commerce Portals, API links, and
//                   much more.
//                 </p>
//               </div>
//               <Link
...
//               data-background="url(assets/images/bg/mobile-app.jpg)"
//             >
//               <h4 className="medium_heading">Mobile App Development</h4>
//               <div className="serviceText">
//                 <p>
//                   In a quest for staying ahead of the technology, it is a
//                   necessity for any business looking to leverage the power of
//                   smartphones to develop mobile apps. Being experienced...
//                 </p>
//               </div>
//               <Link
//                 href="/mobile-application-development-services"
...
//               data-background="url(assets/images/bg/software-development.jpg)"
//             >
//               <h4 className="medium_heading">Software Development</h4>
//               <div className="serviceText">
//                 <p>
//                   We build custom software solutions that will help your
//                   business optimize operations, unlock a new level of efficiency
//                   and transform your ideas into an innovative service or an
//                   engaging...
//                 </p>
//               </div>
//               <Link
        ...
        <div className="servicesWeb">
          <div className="inlineService">
            {services.map((service, index) => (
              ...
              >
                <h4 className="medium_heading">{service.title}</h4>
                <div className="serviceText">

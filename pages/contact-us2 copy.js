  ...
  return (
    <div>
          ...
          <div id="contact_form_section" className="row">
            <div className="col-lg-6">
              <div className="contact_form_box">
                <p className="main_contact_title redText">
                  Drop Us{" "}
                  <span className="blueText fw-bold text-uppercase">A Line</span>
                </p>
            ...
            <div className="col-lg-6">
              <div className="row">
                <p className="main_contact_title redText">
                Reach Out {" "}
                  <span className="blueText fw-bold ">To Us</span>
                </p>
      ...
      <section className="bgGrey">
        <div className="containerFull">
          <h3 className="fontHeading fontWeight600 sub_heading text-center">Our <span className="text_red">Locations</span></h3>
